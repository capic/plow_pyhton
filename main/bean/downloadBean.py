...
class Download:
    ...
    def to_json(self):
        return {"id": self.id,
                ...
                "to_move_directory_id": self.to_move_directory.id if self.to_move_directory is not None else "null",
                "to_move_directory": self.to_move_directory.to_json() if self.to_move_directory is not None else "null",
                "priority": self.priority,
                "theorical_start_datetime": self.theorical_start_datetime,
                "lifecycle_insert_date": self.lifecycle_insert_date,
                "lifecycle_update_date": self.lifecycle_update_date
